...
that provides consistent styling for all R package documentation sites
maintained by the [Economic Policy Institute](https://www.epi.org/).
...
And add this to your `DESCRIPTION` so that GitHub Actions can install
the template:
